...
export function main(source: string, log: (msg: string) => void)   {
...
const assertIncludes = (a, b, msg:string=`Expected ${JSON.stringify(a)} to include ${JSON.stringify(b)}`) => ok(a.includes(b), msg)